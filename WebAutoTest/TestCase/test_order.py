...
class TestOrder(unittest.TestCase):
    ...
    def test_order_01(self):
        """产线大图页入口-个人用户下单-不开票"""
        allure.environment(Report='AutoTest Report', Browser=self.driver.capabilities['version'][:4], ChromeDriver=self.driver.capabilities['chrome']['chromedriverVersion'][:4], URL=self.url)
    ...
    def test_order_07(self):
        ...
        with allure.step('数据库查询SO单号'):
            ...
            allure.attach('SQL Result: ', str(sql_result))
